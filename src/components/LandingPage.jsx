      ...
      <div className="py-16 text-center bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-evenly gap-8">
          {loading ? (
            ...
            <p className="text-gray-600">No toppers available.</p>
          ) : (
              ...
              >
                <div className="relative w-full h-64 overflow-hidden">
                  <img
                    ...
                    crossOrigin="anonymous"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-yellow-800 via-transparent to-transparent opacity-60"></div>
                </div>
                <div className="p-5 text-center">
                  <h3 className="text-xl font-semibold text-gray-800 mb-1">
                    {student.name}
