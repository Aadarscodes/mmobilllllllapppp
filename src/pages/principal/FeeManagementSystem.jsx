...
const FeeManagementSystem = () => {
  ...
  const handleCreate = () => {
    ...
    setFormData({
      ...
      className: "",
      section: "",
      feeType: [], // Initialize as an array for checkboxGroup
      amount: "",
      dueDate: "",
      description: "",
      ...
      case "feecollection":
        return (
          <tr key={item.id} className="hover:bg-gray-50">
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
              {student
                ? `${student.studentName} (${student.Admission_Number})`
                : "Unknown Student"}
            </td>
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
  ...
  // Filtered fee collection for summary/download
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6" ref={printReceiptRef}>
              {/* Receipt Content */}
              <div className="receipt-container p-6 border border-gray-300 rounded-lg">
