...
import { Trash2, XCircle, Wand2 } from "lucide-react"; // Import Wand2 for AI icon
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value="topper_1st">Topper 1st</option>
            <option value="topper_2nd">Topper 2nd</option>
            <option value="topper_3rd">Topper 3rd</option>
            <option value="SchoolLogo">SchoolLogo</option>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            placeholder={type === "other" ? "Optional" : "Enter name"}
            disabled={loading}
          />
        </div>
