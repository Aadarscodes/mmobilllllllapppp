...
const TeacherOnboardingForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    // Include schoolId in the payload for assignedClass and assignedSection
    const payload = {
      ...data,
      schoolId, // Add schoolId to the payload
      assignedClass: {
        className: data.assignedClass,
        schoolId: schoolId, // Ensure class is tied to the correct school
      },
      assignedSection: {
        sectionName: data.assignedSection,
        schoolId: schoolId, // Ensure section is tied to the correct school
      },
    };
